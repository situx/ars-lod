...
# set input csv
file_name = "wd_hercules_loewenstein.csv"
...
for index, row in data.iterrows():
    ...
    pages = str(row["page"])
    if "-" in pages:
        lines.append("LAST" + "\t" + "Den" + "\t" + "\"iconographic description in Löwenstein (2015), pp." + pages + "\"")
    else:
        lines.append("LAST" + "\t" + "Den" + "\t" + "\"iconographic description in Löwenstein (2015), p." + pages + "\"")
    lines.append("LAST" + "\t" + "P31" + "\t" + "Q109525730")
    lines.append("LAST" + "\t" + "P31" + "\t" + "Q838948" + "\t" + "Q105268778")
    lines.append("LAST" + "\t" + "P361" + "\t" + "Q109525632")  # Löwenstein Book (2015)
    lines.append("LAST" + "\t" + "P361" + "\t" + "Q105268778")
    lines.append("LAST" + "\t" + "P170" + "\t" + "Q110454289")
    lines.append("LAST" + "\t" + "P195" + "\t" + "Q109525632")  # Löwenstein Book (2015)
...
f = 0
step = 100000
fileprefix = "wd_hercules_loewenstein"
