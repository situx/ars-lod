...
# set input csv
file_name = "wd_hercules_armstrong.csv"
...
for index, row in data.iterrows():
    ...
    pages = str(row["page"])
    if "-" in pages:
        lines.append("LAST" + "\t" + "Den" + "\t" + "\"iconographic description in Armstrong (1993), pp." + pages + "\"")
    else:
        lines.append("LAST" + "\t" + "Den" + "\t" + "\"iconographic description in Armstrong (1993), p." + pages + "\"")
    lines.append("LAST" + "\t" + "P31" + "\t" + "Q109525730")
    lines.append("LAST" + "\t" + "P31" + "\t" + "Q838948")
    lines.append("LAST" + "\t" + "P361" + "\t" + "Q109525251")  # Armstrong Book (1993)
    lines.append("LAST" + "\t" + "P361" + "\t" + "Q105268778")
    lines.append("LAST" + "\t" + "P170" + "\t" + "Q109525809")
    lines.append("LAST" + "\t" + "P195" + "\t" + "Q109525251")  # Armstrong Book (1993)
...
f = 0
step = 100000
fileprefix = "wd_hercules_armstrong"
